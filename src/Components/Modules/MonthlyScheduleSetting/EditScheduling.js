...
function EditScheduling() {
  ...
  // };
  const handleDateChange = (setter, mirrorSetter = null) => (e) => {
    const value = e.target.value;
    setter(value);
    if (mirrorSetter) {
      mirrorSetter(value); // Sync to the end date
    }
  };
                      ...
                      <div className="dates flex items-center w-[400px] justify-between">
                        <div className="dmy flex items-center bg-white rounded">
                          <input
                            ...
                            onChange={handleDateChange(setVacationStartMonth, setVacationEndMonth)}
                          />
                          <span>/</span>
                          <input
                            className="py-2 text-center focus:outline-none w-[40px] rounded"
                            ...
                            onChange={handleDateChange(setVacationStartDay, setVacationEndDay)}
                          />
                          <span>/</span>
                          <input
                            ...
                            onChange={handleDateChange(setVacationStartYear, setVacationEndYear)}
                          />
                        </div>
