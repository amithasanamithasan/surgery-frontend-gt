    ...
    <>
      {isVisible2 && (
        ...
        >
          <div
            ref={divRef2}
            className="drag-handle vacation-counter absolute bg-white rounded-xl h-auto w-[950px] shadow-[rgba(0,_0,_0,_0.4)_0px_5px_60px] m-auto left-0 right-0 top-[60px] z-[300]"
          >
            <div className=" cursor-pointer p-8 relative">
              <button
