...
const SearchByDateDs = () => {
  ...
  useEffect(() => {
    setStartDate(initialDate.clone());
  }, [initialDate]);
            ...
            <div className="flex bg-white rounded-xl py-4 px-5 justify-between overflow-hidden">
              ...
              {daysArray.map((date) => (
                <div
                  ...
                  className={`item border-2 border-black sm:px-2 lg:px-1 2xl:px-2 py-1 rounded-md inter-medium text-[14px] content-center ${date.isSame(dated, "day") ? "active" : ""
                    }`}
                >
