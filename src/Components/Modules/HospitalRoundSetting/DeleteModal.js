...
const DeleteModal = ({ show, onClose, onDelete, deleteMessage }) => {
    ...
    return (
        <div id="myModal" className="modal-delete fixed inset-0 flex items-center justify-center bg-black bg-opacity-50" onClick={handleBackgroundClick} aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div className="modal-delete-content py-10">
                ...
                <p className="pt-[28px] pb-1 inter-bold text-[22px] flex justify-center">
                    Are you sure you want to delete?
                </p>
                <p className="pb-[10px] text-[18px] flex justify-center">
                    This will permanently delete the record.
                </p>
                {deleteMessage && (
                    <p className="flex justify-center text-red-500 mb-5">{deleteMessage}</p>
                )}
